...
export default function WhatsAppFloat({ message }: { message: string }) {
  return (
    ...
    >
      ...
      <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-brand-red text-[10px] font-bold text-white ring-2 ring-background">
        1
      </span>
    </a>
  );
